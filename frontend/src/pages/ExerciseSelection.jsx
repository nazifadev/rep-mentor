    ...
    <p className="text-gray-400 text-xs 2xl:text-sm tracking-widest uppercase pt-5 md:pt-8 text-center md:text-left">
      choose your exercise
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 pt-2 md:pt-0 md:gap-4 w-full 2xl:pb-0">        
          <button onClick={() => handleExerciseSelect('squat')} className="bg-white hover:bg-[#cefcff] rounded-2xl p-4 md:p-6 flex flex-col justify-end items-start min-h-[100px] sm:min-h-[160px] md:min-h-[260px] 2xl:min-h-[300px] text-left hover:-translate-y-2 transition-all duration-200">
          ...
          <button onClick={() => handleExerciseSelect('push-up')} className="bg-white hover:bg-[#cefcff] rounded-2xl p-4 md:p-6 flex flex-col justify-end items-start min-h-[100px] sm:min-h-[160px] md:min-h-[260px] 2xl:min-h-[300px] text-left hover:-translate-y-2 transition-all duration-200">
